...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "rar", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        ...
        //type.Dir = BaseDir == "" ? "" : BaseDir + "upload/";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "mp3", "mp4", "avi", "swf", "xlsx" };
        //type.DeniedExtensions = new string[] { };
